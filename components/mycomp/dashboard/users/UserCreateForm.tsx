...
const formSchema = z.object({
  ...
  phoneNumber: z.string().regex(/^\+90 \d{3} \d{3} \d{2} \d{2}$/, {
...
const formatPhone = (val: string) => {
  ...
  return `+90 ${part1}${part2 ? " " + part2 : ""}${part3 ? " " + part3 : ""}${
    part4 ? " " + part4 : ""
  }`.trim();
};
...
const FormInput = React.forwardRef<HTMLInputElement, FormInputProps>(
  ({ icon, showSuccess, error, className, ...props }, ref) => (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-md">
                    Sisteme yeni bir kullanıcı profili ekleyin.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <FormInput
                              ...
                              showSuccess={
                                field.value.length === 11 && !fieldState.error
                              }
                            />
                          </FormControl>
                          <FormMessage />
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <FormInput
                              ...
                              error={fieldState.error}
                              showSuccess={
                                field.value.length > 5 && !fieldState.error
                              }
                            />
                          </FormControl>
                          <FormMessage />
          ...
          <div className="sticky top-8">
            <Card className="shadow-lg border-none rounded-xl">
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl">Son Eklenenler</CardTitle>
                  ...
                  {newlyAddedUsers.length > 0 ? (
                    ...
                    >
                      {newlyAddedUsers.map((user) => (
                        <motion.div
                          ...
                          className="flex items-center justify-between p-3 border rounded-lg bg-card transition-shadow hover:shadow-md"
                        >
                          <div className="flex items-center gap-4">
                          ...
                          <div className="text-xs font-semibold px-2.5 py-1 bg-primary/10 text-primary rounded-full capitalize">
                    ...
                    <div className="text-center py-12 px-6 border-2 border-dashed rounded-lg">
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Formu doldurarak yeni bir kullanıcı ekleyin.
                      </p>
                    </div>
                  )}
                </AnimatePresence>
